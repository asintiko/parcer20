...
from sqlalchemy import (
    ...
    Float, Integer, Numeric, String, Text, Index, UniqueConstraint, Uuid
)
...
class Transaction(Base):
    ...
    __table_args__ = (
        ...
        Index('idx_transactions_source_msg', 'source_chat_id', 'source_message_id'),
...
class TgChatMessage(Base):
    ...
    __table_args__ = (
        ...
        Index("idx_tg_chat_messages_chat_msg", "chat_id", "message_id"),
