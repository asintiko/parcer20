...
Return ONLY a JSON object matching TransactionSchema keys."""
    ...
    def parse(self, text: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            logger.warning("AI text parsing error: %s", e)
            return None
    ...
    def parse_from_images(self, images_b64: List[str], text_hint: Optional[str] = None) -> Optional[Dict[str, Any]]:
        """Compatibility shim. Image receipts should go through OCR/text extraction first."""
        _ = images_b64, text_hint
        logger.info("Direct image parsing compatibility shim invoked; OCR/text path should be used instead")
        return None
